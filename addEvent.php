        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <form action="addEvent.php" method="post" enctype="multipart/form-data" class="ml-xl-5 mr-xl-5 px-5">
                        <div class="row">
                            <label class="col">Event Title</label>
                            <input class="col form-input" name="title" placeholder="Please write the event name here!" type="text">
                        </div>
                        <div class="row">
                            <label class="col">Event Type</label>
                            <input class="col form-input" name="type" placeholder="Please write the event type here!" type="text">
                        </div>
                        <div class="row">
                            <label class="col">Starting Date</label>
                            <input class="col form-input" name="stDate" type="date">
                        </div>
                        <div class="row">
                        ...
                        <div class="row ml-5">
                            <div class="col pl-5 ml-xl-5">
                                ...
                                <input class="form-control col" accept="image/*" name="poster" type="file" id="DefaultFile">
                            </div>
                            <div class="col">
                                <label for="MultipleFile" class="col">File Pictures</label>
                                <input class="form-control col" name="assets[]" accept="image/*" type="file" multiple id="MultipleFile">
                            </div>
                            <div class="col">
                                <label for="MultipleFileVid" class="col">File Videos</label>
                                <input class="form-control col" name="videos[]" accept="video/mp4" type="file" multiple id="MultipleFileVid">
                            </div>
                        </div>
                        <div class="row">
                            <input class="mx-auto button button-primary-outline" type="submit" name="submit" value="Create Event">
                        </div>
                    </form>
                </div>
            </div>
